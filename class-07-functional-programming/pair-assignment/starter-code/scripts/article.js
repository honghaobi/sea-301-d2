...
Article.fetchAll = function(post) {
...
Article.numWordsAll = function() {
  return Article.all.map(function(article) {
    return article.body.split(/\S+/g).length;
  })
  .reduce(function(a, b) {
    return a + b;
...
// Done: Chain together a `map` and a `filter` call to produce an array of unique author names.
